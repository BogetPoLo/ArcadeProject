...
class MainCharacter(arcade.Sprite):
    ...
    def __init__(self, keys_pr):
        ...
        "загружаем текстуры"
        self.textures = [arcade.load_texture("player_textures/alienGreen.png"),  # Стоит
                         arcade.load_texture("player_textures/alienGreen_walk1.png"),  # Бежит влево 1
                         arcade.load_texture("player_textures/alienGreen_walk2.png"),  # Бежит влево 2
                         arcade.load_texture("player_textures/alienGreen_walk1.png").flip_horizontally(),
                         # Бежит вправо 1
                         arcade.load_texture("player_textures/alienGreen_walk2.png").flip_horizontally(),
                         # Бежит вправо 2
                         arcade.load_texture("player_textures/alienGreen_climb1.png"),  # Идёт на верх 1
                         arcade.load_texture("player_textures/alienGreen_climb2.png")]  # Идёт на верх 2
    ...
    def update(self, delta_time):
        ...
        elif all([True if key not in self.keys_pr else False for key in
